  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>
          Staff bus rental services in UAE provide convenient, reliable, and affordable transportation solutions for groups of all sizes. Call Click Passenger Transport UAE today for best coach hire services in UAE.
        </p>
      </div>
...
<div class="modal fade" id="schoolTransferModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>
          Students transportation services in UAE are a great option for those looking to transport students to and from school safely and comfortably. Click Passenger Transport offered affordable bus rental services in UAE.
        </p>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
...
<div class="modal fade" id="cityTourModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">City Tours and Picknics</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <p>
          Click Passenger Transport UAE provides top–notch office bus rental services for City Tours and Picknicss in UAE. Our service is designed to provide a comfortable and convenient way to explore the city and its attractions.
        </p>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
